...
abstract class AbstractWorkflowModel extends RecordDocumentModel[Workflow] with JsonConversion[Workflow] {
  ...
  val pauseRequested: I[Boolean] = field.index("pauseRequested", _.pauseRequested)
  val pausedStepId: I[Option[Id[Step]]] = field.index("pausedStepId", _.pausedStepId)
  val pauseCheckpoint: F[Option[Json]] = field("pauseCheckpoint", _.pauseCheckpoint)
